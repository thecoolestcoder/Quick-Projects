#headings
print('Hello! Welcome to MakeYourStory the fun helper to an Author')
print('Now let us quickly make our story')
#inputs
place = input('where is your story based in: ')
hero = input('who is your hero: ')
villain = input('who is the villain: ')
#maincode
print('making your story...')
